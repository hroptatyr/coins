...
#define API_HOST	"fix.paymium.com"
#define API_PORT	8359

#define TCOMP_ID	"PAYMIUM"
#define SCOMP_ID	"libcoins"
...
fix_hello(void)
{
	...
	fix_reset();
	len = fix_render(buf, sizeof(buf), (fix_msg_t){"A", strlenof(hi), hi});
